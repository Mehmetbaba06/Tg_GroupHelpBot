...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(
        InlineKeyboardButton(
            strings["crowdin_btn"], url="https://t.me/AkcrazyTechGiveaways"
        )
    )
    if edit:
...
__help__ = """
This module is dedicated towards utlising Avengers-Bot's localization feature! You can also <a href='www.youtube.com/c/Akcrazytech'>contribute</a> for improving localization in Avengers-Bot
...
Avengers-Bot will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
