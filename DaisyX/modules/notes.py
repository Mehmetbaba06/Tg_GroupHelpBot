...
Also notes perfectly working in PM with Avengers-Bot.
...
*Avengers* can save notes from other bots, just reply /save on the saved message from another bot, saving pictures and buttons supported aswell.
