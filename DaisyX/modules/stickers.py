...
async def _(event):
    ...
    packshortname = f"Avengers_stickers_{userid}"
    kanga = await event.reply("Hello, This Sticker Looks Noice. Mind if Avengers-Bot steal it")
    ...
    if is_a_s:
        ...
        packshortname = f"Avengers_animated_{userid}"
